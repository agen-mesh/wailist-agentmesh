...
public class MainActivity extends BridgeActivity {
    // Bounds for the system font scale the WebView follows; see onCreate.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //
        // fontScale is not in configChanges in AndroidManifest.xml, so changing
        // the system font size recreates this activity and this runs again.
        float fontScale = getResources().getConfiguration().fontScale;
        float cappedScale = Math.max(MIN_FONT_SCALE, Math.min(fontScale, MAX_FONT_SCALE));

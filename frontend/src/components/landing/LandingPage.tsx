...
function LogoMarquee() {
  ...
  return (
    <div style={{ padding: isMobile ? "0 20px 32px" : "0 32px 40px", position: "relative", zIndex: 11 }}>
...
function LandingPillars() {
  ...
  return (
    <section id="pillars" style={{
      padding: isMobile ? "72px 20px" : "128px 32px", borderTop: "1px solid var(--border)",
      position: "relative", zIndex: 1, background: "rgba(4, 3, 12, 0.55)",
    }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div className="in-view" style={{ marginBottom: isMobile ? 40 : 72 }}>
          <Tag>what is agentmesh</Tag>
          <h2 style={{ margin: "16px 0 0", fontSize: isMobile ? 30 : 48, fontWeight: 500, letterSpacing: "-0.028em", maxWidth: 680, fontFamily: "var(--font-sans)", lineHeight: 1.12 }}>
...
function LandingFlow() {
  ...
  return (
    <section id="flow" style={{ borderTop: "1px solid var(--border)", background: "rgba(4, 3, 12, 0.62)", padding: isMobile ? "64px 20px" : "112px 32px", position: "relative", zIndex: 1 }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div className="in-view" style={{ marginBottom: isMobile ? 36 : 64 }}>
          <Tag>flow</Tag>
          <h2 style={{ margin: "16px 0 0", fontSize: isMobile ? 26 : 40, fontWeight: 500, letterSpacing: "-0.025em", fontFamily: "var(--font-sans)", lineHeight: 1.15 }}>
            Zero to running pipeline in four moves.
          </h2>
        </div>
        <div className="in-view" style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(4, 1fr)", gap: 12 }}>
          {steps.map((s, i) => (
...
function LandingWaitlist() {
  ...
  return (
    <section id="waitlist" style={{ borderTop: "1px solid var(--border)", padding: isMobile ? "72px 20px" : "128px 32px", position: "relative", zIndex: 1, background: "rgba(4, 3, 12, 0.55)" }}>
      <div className="in-view" style={{ maxWidth: 540, margin: "0 auto", textAlign: "center" }}>
        <Tag>early access</Tag>
        <h2 style={{ margin: "20px 0 14px", fontSize: isMobile ? 34 : 48, fontWeight: 500, letterSpacing: "-0.028em", fontFamily: "var(--font-sans)", lineHeight: 1.1 }}>Join the waitlist.</h2>
        ...
        <div style={{ padding: "32px 32px 28px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 18, backdropFilter: "blur(12px)", boxShadow: "0 0 60px rgba(167,140,250,0.07), inset 0 1px 0 rgba(255,255,255,0.06)" }}>
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: isMobile ? "column" : "row", gap: 8 }}>
...
function LandingFooter() {
  const isMobile = useMobile();
  return (
    <footer style={{ borderTop: "1px solid var(--border)", padding: isMobile ? "28px 20px" : "32px 32px", position: "relative", zIndex: 1, background: "rgba(4, 3, 12, 0.70)" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: isMobile ? "flex-start" : "center", gap: isMobile ? 16 : 0, justifyContent: "space-between", fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--fg-dim)" }}>

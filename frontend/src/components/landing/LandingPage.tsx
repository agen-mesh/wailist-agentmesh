...
function LogoMarquee() {
  const logos = [
    { letter: "A", name: "Algorand" },
    { letter: "x", name: "x402" },
    { letter: "G", name: "GoPlausible" },
    { letter: "P", name: "Pera Wallet" },
    { letter: "T", name: "Tavily" },
    { letter: "F", name: "Firecrawl" },
    { letter: "N", name: "Neon" },
    { letter: "A", name: "AlpacaQuote" },
  ];
...
function LandingPillars() {
  const pillars = [
    ...
    },
    {
      tag: "02",
      kicker: "fund",
      title: "Wallets at deploy, not signup.",
      body: "Each agent gets an Ed25519 keypair on Algorand testnet the moment you deploy. Fund manually, watch balances tick live.",
      glyph: "◎",
    },
    {
      tag: "03",
      kicker: "wire",
      title: "x402 paywalled APIs as tools.",
      body: "Any HTTP 402-compliant endpoint becomes a tool node. Price-discovered at edge-time, settled per call, accountable per agent.",
      glyph: "⟡",
    },
    {
      tag: "04",
      kicker: "run",
      title: "A2A messages anchored on-chain.",
      body: "Inter-agent messages produce verifiable receipts. Replay any run by anchor hash. Audit-friendly by default.",
      glyph: "◈",
    },
  ];
  return (
...
function LandingFlow() {
  const steps = [
    ...
    },
    {
      k: "03",
      label: "Deploy",
      body: "Agents get Algorand testnet wallets at this moment.",
      glyph: "◎",
    },
    {
      k: "04",
      label: "Fund + run",
      body: "Top up agent balances. Watch x402 settlements live.",
      glyph: "▶",
    },
  ];
  return (
